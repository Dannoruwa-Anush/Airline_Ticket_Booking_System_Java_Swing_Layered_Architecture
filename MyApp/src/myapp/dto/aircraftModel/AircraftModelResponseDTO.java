...
public class AircraftModelResponseDTO {
    ...
    public AircraftModelResponseDTO() {
    }

    public AircraftModelResponseDTO(int aircraftModel_id, String aircraftModel_Manufacturer, String aircraftModel_Name, int aircraftModel_SeatCapacity, BigDecimal aircraftModel_Range_KM, String aircraftModel_SizeCategory) {
    ...
    public String getAircraftModelInfo() {
        String manufacturer = (aircraftModel_Manufacturer != null) ? aircraftModel_Manufacturer : "Unknown";
        String model = (aircraftModel_Name != null) ? aircraftModel_Name : "Unknown";
