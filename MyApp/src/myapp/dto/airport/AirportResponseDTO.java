...
public class AirportResponseDTO {
    ...
    public AirportResponseDTO(int airport_id, String airport_code, String airport_name, String airport_city, String airport_country) {
    ...
    public String toString() {
        return airport_name; // This will display only the airport_name in JComboBox
    }
