...
public class BookingClassResponseDTO {
    ...
    public BookingClassResponseDTO() {
    }

    public BookingClassResponseDTO(int bookingClass_id, String bookingClass_name) {        
    ...
    public String toString() {
        return "BookingClassResponseDTO{" + "bookingClass_id=" + bookingClass_id + ", bookingClass_name=" + bookingClass_name + '}';
    }
