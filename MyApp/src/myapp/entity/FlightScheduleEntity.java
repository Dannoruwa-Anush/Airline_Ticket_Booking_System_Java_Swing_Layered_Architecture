...
public class FlightScheduleEntity {
    ...
    public FlightScheduleEntity(int schedule_id, RouteEntity route, AircraftModelEntity aircraftModel, String schedule_flight_code, String schedule_airline_name, LocalTime schedule_departure_time, LocalTime schedule_arrival_time, Set<String> schedule_days_of_week) {
    ...
    public String toString() {
        return "FlightScheduleEntity{" + "schedule_id=" + schedule_id + ", route=" + route + ", aircraftModel=" + aircraftModel + ", schedule_flight_code=" + schedule_flight_code + ", schedule_airline_name=" + schedule_airline_name + ", schedule_departure_time=" + schedule_departure_time + ", schedule_arrival_time=" + schedule_arrival_time + ", schedule_days_of_week=" + schedule_days_of_week + '}';
    }
